...
import brandLogo from "@/assets/brand/VICCS_Design_Logo_txt.svg.asset.json";
import character from "@/assets/brand/VICCS_CharacterSideProfile.svg.asset.json";
